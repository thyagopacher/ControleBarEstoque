...
public class GestaoCondominioPortType_inserirProduto_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final int mySTATUS_INDEX = 5;
    
    public GestaoCondominioPortType_inserirProduto_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct instance = new servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct();
        servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<6; i++) {
            ...
            if (elementName.equals(ns1_nome_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct instance = (servico_web.GestaoCondominioPortType_inserirProduto_RequestStruct)obj;
