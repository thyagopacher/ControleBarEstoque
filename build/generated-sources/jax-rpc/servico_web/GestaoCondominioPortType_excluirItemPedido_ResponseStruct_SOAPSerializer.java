...
public class GestaoCondominioPortType_excluirItemPedido_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public GestaoCondominioPortType_excluirItemPedido_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct instance = new servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct();
        servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_retorno_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct instance = (servico_web.GestaoCondominioPortType_excluirItemPedido_ResponseStruct)obj;
